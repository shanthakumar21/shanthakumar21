...
<I><a href= "[https://arxiv.org/abs/2111.12289](https://github.com/shanthakumar21/Data-Engineer-Test-for-Fetch---Shanthakumar-Sivakumar)">The project involves a real-time streaming data pipeline using Kafka and Docker, with a Flask server with dash and other components to display the data on a web dashboard (ICASETM-21)</I></a>  
<Br>
<Br>
